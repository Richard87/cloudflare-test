...
const commonTexts = {
  signIn: {
    phoneCode: {
      ...
      formSubtitle:
        "Skriv inn verifiseringskoden sendt til telefonnummeret ditt",
...
export const nbNO: LocalizationResource = {
  ...
  signUp: {
    ...
    emailLink: {
      ...
      formSubtitle:
        "Bruk verifiseringslenken som er sendt til e-postadressen din",
    ...
    emailCode: {
      ...
      formTitle: "Verifiseringskode",
      formSubtitle:
        "Skriv inn verifiseringskoden som er sendt til e-postadressen din",
      resendButton: "Send kode på nytt",
    },
    phoneCode: {
      ...
      formTitle: "Verifiseringskode",
      formSubtitle:
        "Skriv inn verifiseringskoden som er sendt til telefonnummeret ditt",
      resendButton: "Send kode på nytt",
    },
    continue: {
  ...
  signIn: {
    ...
    forgotPassword: {
      ...
      formSubtitle_phone:
        "Skriv inn koden som er sendt til telefonnummeret ditt",
      resendButton: "Send kode på nytt",
    },
    resetPassword: {
      ...
      successMessage:
        "Passordet ditt er blitt tilbakestilt. Logger deg inn, vennligst vent et øyeblikk.",
    },
    resetPasswordMfa: {
      detailsLabel:
        "Vi må bekrefte identiteten din før vi tilbakestiller passordet ditt.",
    },
    emailCode: {
    ...
    totpMfa: {
      ...
      formTitle: "Verifiseringskode",
      formSubtitle:
        "Skriv inn verifiseringskoden generert av autentiseringsappen din",
    },
    backupCodeMfa: {
    ...
    noAvailableMethods: {
      ...
      message:
        "Kan ikke fortsette med innloggingen. Det er ingen tilgjengelige autentiseringsfaktorer.",
    },
  },
  userProfile: {
    ...
    start: {
      ...
      emailAddressesSection: {
        ...
        detailsSubtitle__primary:
          "Denne e-postadressen er den primære e-postadressen",
        ...
        detailsSubtitle__unverified:
          "Denne e-postadressen er ikke verifisert og kan ha begrenset funksjonalitet",
        detailsAction__unverified: "Fullfør verifisering",
        destructiveActionTitle: "Fjern",
        destructiveActionSubtitle:
          "Slett denne e-postadressen og fjern den fra kontoen din",
      ...
      phoneNumbersSection: {
        ...
        detailsSubtitle__primary:
          "Dette telefonnummeret er det primære telefonnummeret",
        detailsAction__primary: "Fullfør verifisering",
        ...
        detailsSubtitle__unverified:
          "Dette telefonnummeret er ikke verifisert og kan ha begrenset funksjonalitet",
        detailsAction__unverified: "Fullfør verifisering",
        destructiveActionTitle: "Fjern",
        destructiveActionSubtitle:
          "Slett dette telefonnummeret og fjern det fra kontoen din",
      ...
      connectedAccountsSection: {
        ...
        destructiveActionTitle: "Fjern",
        destructiveActionSubtitle:
          "Fjern denne tilkoblede kontoen fra kontoen din",
      ...
      mfaSection: {
        ...
        phoneCode: {
          destructiveActionTitle: "Fjern",
          destructiveActionSubtitle:
            "Fjern dette telefonnummeret fra to-trinns verifisering",
        ...
        totp: {
          ...
          destructiveActionTitle: "Fjern",
          destructiveActionSubtitle:
            "Fjern autentiseringsapplikasjonen fra to-trinns verifisering",
      ...
      web3WalletsSection: {
        ...
        destructiveActionTitle: "Fjern",
        destructiveActionSubtitle:
          "Fjern denne web3-lommeboken fra kontoen din",
    ...
    profilePage: {
      ...
      fileDropAreaHint:
        "Last opp et JPG, PNG, GIF eller WEBP-bilde som er mindre enn 10 MB",
      readonly:
        "Informasjonen om profilen din er levert av bedriftstilkoblingen og kan ikke redigeres.",
    ...
    emailAddressPage: {
      ...
      emailCode: {
        formHint:
          "En e-post med en verifiseringskode vil bli sendt til denne e-postadressen.",
        formTitle: "Verifiseringskode",
        formSubtitle:
          "Skriv inn verifiseringskoden som er sendt til {{identifier}}",
        resendButton: "Send kode på nytt",
        successMessage:
          "E-posten {{identifier}} har blitt lagt til kontoen din.",
      },
      emailLink: {
        formHint:
          "En e-post med en verifiseringslenke vil bli sendt til denne e-postadressen.",
        formTitle: "Verifiseringslenke",
        formSubtitle:
          "Klikk på verifiseringslenken i e-posten sendt til {{identifier}}",
        resendButton: "Send lenke på nytt",
        successMessage:
          "E-posten {{identifier}} har blitt lagt til kontoen din.",
      },
      removeResource: {
        ...
        messageLine2:
          "Du vil ikke lenger kunne logge inn med denne e-postadressen.",
    ...
    phoneNumberPage: {
      ...
      infoText:
        "En tekstmelding med en verifiseringslenke vil bli sendt til dette telefonnummeret.",
      infoText__secondary: "Meldings- og datatilleggskostnader kan påløpe.",
      removeResource: {
        title: "Fjern telefonnummer",
        messageLine1: "{{identifier}} vil bli fjernet fra denne kontoen.",
        messageLine2:
          "Du vil ikke lenger kunne logge inn med dette telefonnummeret.",
    ...
    connectedAccountPage: {
      ...
      formHint__noAccounts:
        "Det er ingen tilgjengelige eksterne konto-tilbydere.",
      ...
      removeResource: {
        ...
        successMessage:
          "{{connectedAccount}} har blitt fjernet fra kontoen din.",
      },
    },
    web3WalletPage: {
      title: "Legg til web3-lommebok",
      subtitle__availableWallets:
        "Velg en web3-lommebok for å koble til kontoen din.",
      subtitle__unavailableWallets:
        "Det er ingen tilgjengelige web3-lommebøker.",
      successMessage: "Lommeboken har blitt lagt til kontoen din.",
      removeResource: {
        title: "Fjern web3-lommebok",
        messageLine1: "{{identifier}} vil bli fjernet fra denne kontoen.",
        messageLine2:
          "Du vil ikke lenger kunne logge inn med denne web3-lommeboken.",
    ...
    passwordPage: {
      ...
      readonly:
        "Passordet ditt kan for øyeblikket ikke endres fordi du kun kan logge inn via bedriftstilkoblingen.",
      ...
      sessionsSignedOutSuccessMessage:
        "Alle andre enheter har blitt logget ut.",
    },
    mfaPage: {
    ...
    mfaTOTPPage: {
      ...
      removeResource: {
        ...
        messageLine1:
          "Verifiseringskoder fra denne autentiseringsappen vil ikke lenger være påkrevd ved pålogging.",
        messageLine2:
          "Kontoen din kan bli mindre sikker. Er du sikker på at du vil fortsette?",
        successMessage:
          "To-trinns verifisering via autentiseringsappen er fjernet.",
      },
    },
    mfaPhoneCodePage: {
      ...
      removeResource: {
        title: "Fjern to-trinns verifisering",
        messageLine1:
          "{{identifier}} vil ikke lenger motta verifiseringskoder ved pålogging.",
        messageLine2:
          "Kontoen din kan bli mindre sikker. Er du sikker på at du vil fortsette?",
        successMessage:
          "SMS-kode to-trinns verifisering er fjernet for {{mfaPhoneCode}}",
      },
    },
    backupCodePage: {
  ...
  organizationProfile: {
    ...
    invitePage: {
      ...
      detailsTitle__inviteFailed:
        "Invitasjonene kunne ikke sendes. Fiks følgende og prøv igjen:",
  ...
  unstable__errors: {
    ...
    zxcvbn: {
      ...
      couldBeStronger:
        "Passordet ditt fungerer, men det kan være sterkere. Prøv å legge til flere tegn.",
      goodPassword: "Godt jobbet. Dette er et utmerket passord.",
      warnings: {
        straightRow:
          "Rette rader med tastene på tastaturet ditt er lett å gjette.",
        keyPattern: "Korte tastaturmønstre er lett å gjette.",
        simpleRepeat: 'Gjentatte tegn som "aaa" er lett å gjette.',
        extendedRepeat:
          'Gjentatte tegnmønstre som "abcabcabc" er lett å gjette.',
      ...
      suggestions: {
        ...
        longerKeyboardPattern:
          "Bruk lengre tastaturmønstre og endre skrivretning flere ganger.",
        anotherWord: "Legg til flere ord som er mindre vanlige.",
        useWords: "Bruk flere ord, men unngå vanlige fraser.",
        noNeed:
          "Du kan lage sterke passord uten å bruke symboler, tall eller store bokstaver.",
